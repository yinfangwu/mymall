...
public class UserServiceImpl implements UserService {
    ...
    public ServerResponse<User> login(String username, String password) {
        ...
        //登陆成功，敏感信息不返回，可以新建一个专门返回的UserVo
    ...
    @Override
    public ServerResponse<String> register(String str, String type) {
        return null;
    }
    ...
    public ServerResponse<String> checkQuestionAnswer(String username, String question, String answer) {
        int resultCount = userMapper.selectQuestionAnswer(username, question);
        //有此用户即对应的问题也回答正确
        if (resultCount > 0){
    ...
    public ServerResponse<String> forgetResetPassword(String username, String passwordNew, String forgetToken) {
        ...
        if (StringUtils.isBlank(forgetToken)){
            return ServerResponse.createByErrorMessage("token不能空");
        }
    ...
    public ServerResponse updateUserInfo(User user) {
        ...
        //fixme有个字段updateTime 默认设置为mysql的now()函数，
        //但是mybatis的动态sql判断updateTime不为空是更新，应该改为只要更新了信息就更新该字段
